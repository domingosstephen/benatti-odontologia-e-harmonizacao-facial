...
const images: GalleryImage[] = [
  { src: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=800&q=80', alt: 'Atendimento odontologico profissional', caption: 'Cuidado Profissional' },
  { src: 'https://images.unsplash.com/photo-1598256989800-fe5f95da9787?auto=format&fit=crop&w=800&q=80', alt: 'Clinica odontologica moderna', caption: 'Estrutura Moderna' },
  { src: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=800&q=80', alt: 'Tratamento estetico dental', caption: 'Estetica Dental' },
  { src: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?auto=format&fit=crop&w=800&q=80', alt: 'Harmonizacao facial', caption: 'Harmonizacao Facial' },
  { src: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&w=800&q=80', alt: 'Ambiente sofisticado', caption: 'Sofisticacao e Conforto' },
];
